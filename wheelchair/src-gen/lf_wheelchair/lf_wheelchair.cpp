...
void lf_wheelchairreaction_function_1(void* instance_args) {
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wunused-variable"
    lf_wheelchair_self_t* self = (lf_wheelchair_self_t*)instance_args;
...
lf_wheelchair_self_t* new_lf_wheelchair() {
    ...
    self->_lf__reaction_1.function = lf_wheelchairreaction_function_1;
...
void _lf_initialize_trigger_objects() {
    ...
    // Total number of outputs (single ports and multiport channels) produced by the reaction.
    lf_wheelchair_self->_lf__reaction_1.num_outputs = 0;
    // Allocate arrays for triggering downstream reactions.
    if (lf_wheelchair_self->_lf__reaction_1.num_outputs > 0) {
        lf_wheelchair_self->_lf__reaction_1.output_produced 
                = (bool**)malloc(sizeof(bool*) * lf_wheelchair_self->_lf__reaction_1.num_outputs);
        lf_wheelchair_self->_lf__reaction_1.triggers 
                = (trigger_t***)malloc(sizeof(trigger_t**) * lf_wheelchair_self->_lf__reaction_1.num_outputs);
        lf_wheelchair_self->_lf__reaction_1.triggered_sizes 
                = (int*)calloc(lf_wheelchair_self->_lf__reaction_1.num_outputs, sizeof(int));
    }
    // Initialize the output_produced array.
    ...
    // Reaction 1 of lf_wheelchair depends on one maximal upstream reaction.
    lf_wheelchair_self->_lf__reaction_1.last_enabling_reaction = &(lf_wheelchair_self->_lf__reaction_0);
    ...
    lf_wheelchair_self->_lf__reaction_0.index = 0x7fffffffffff0000LL;
    lf_wheelchair_self->_lf__reaction_1.chain_id = 1;
    // index is the OR of level 1 and 
    // deadline 140737488355327 shifted left 16 bits.
    lf_wheelchair_self->_lf__reaction_1.index = 0x7fffffffffff0001LL;
}
